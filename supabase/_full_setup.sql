-- ============================================================
-- siwoo / AI Commerce Agent — full database setup
-- Run this once in the Supabase SQL Editor of project iqoalqycxktcuigwuwcj
-- (combined from supabase/migrations in timestamp order)
-- ============================================================

-- >>>>>>>>>> migrations/20260619083435_c5031ca8-122e-441d-876c-6ad7b82dca2c.sql <<<<<<<<<<
...
-- >>>>>>>>>> migrations/20260619084242_5f577f4c-bbe8-4e9a-b182-f10ee96be943.sql <<<<<<<<<<
...
-- >>>>>>>>>> migrations/20260619085148_8bc9ea8f-e9be-483c-b74b-a4c37439401c.sql <<<<<<<<<<
-- 1. Role enum
DO $$ BEGIN
...
-- >>>>>>>>>> migrations/20260619085207_a9f25d89-4d5f-4d48-a8e2-0aed92c26c59.sql <<<<<<<<<<
REVOKE EXECUTE ON FUNCTION public.has_role(uuid, public.app_role) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.has_role(uuid, public.app_role) TO service_role;

-- >>>>>>>>>> migrations/20260619085224_89c99c9c-86e4-4588-9476-3bb2ba91f284.sql <<<<<<<<<<
REVOKE EXECUTE ON FUNCTION public.handle_new_user_role() FROM PUBLIC, anon, authenticated;

-- >>>>>>>>>> migrations/20260619090105_6f4efff7-70a6-4abf-bf42-fb77941618c0.sql <<<<<<<<<<
GRANT EXECUTE ON FUNCTION public.has_role(uuid, public.app_role) TO authenticated;

-- >>>>>>>>>> migrations/20260619101855_0ec56ab7-b92c-4a99-8d4d-9ea93c1a5374.sql <<<<<<<<<<
...
-- >>>>>>>>>> migrations/20260619122309_93a64eea-5e1f-4c5c-9ce0-ab187b29c06a.sql <<<<<<<<<<
-- (skipped) seeded a specific admin user from the old Lovable project; not valid on a fresh project.
-- The first account that signs up becomes admin automatically via handle_new_user_role().

-- >>>>>>>>>> migrations/20260620090000_ai_engines.sql <<<<<<<<<<
